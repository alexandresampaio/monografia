...
=======
  • Organização de arquivos em Rails
   ...
   •Definição de Scaffod
		    ...
		    O scaffold é um comando que cria uma arquitetura de acordo com os 
	   parâmetros desejados criando automaticamente um controlador, 
	   um modelo e todas as views necessárias para interpretar todas 
	   as operações de inclusão, edição, visualização e remoção. 
...
>>>>>>> 7958fb775c9195dabe2ba456daad609c555ba89e
