...
Na Prática todo e qualquer modelo criado pelo gerador de componentes do rails o mesmo estende a classe nativa \textbf{ActiveRecord::Base} responsável por abstrair uma entidade contida na base de dados, assim como cada objeto representa uma linha do banco de dados como menciona \cite{PRAGMATIC}.


 serão abstrações d
e uma entidade contida no banco de dados,
assim, os objetos dessas classes correspondem a linhas das tabelas, como explica
RUBY
(2009)
